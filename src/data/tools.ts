...
export const categories: Category[] = [
  { id: "1", slug: "chatbot", name: "AI Chatbots", description: "Intelligent conversational AI assistants for tasks, research, and creativity", icon: "🤖", toolCount: 5 },
  ...
  { id: "3", slug: "video", name: "Video & Animation", description: "Generate, edit, and enhance videos using artificial intelligence", icon: "🎬", toolCount: 8 },
  { id: "4", slug: "audio", name: "Audio & Music", description: "Generate realistic speech, music, and audio content with AI", icon: "🎵", toolCount: 3 },
  { id: "5", slug: "code", name: "Code & Development", description: "AI-powered coding assistants and development tools", icon: "💻", toolCount: 5 },
  ...
  { id: "8", slug: "design", name: "Design & UI", description: "AI-assisted design tools for interfaces, graphics, and branding", icon: "🖌️", toolCount: 3 },
...
export const tools: Tool[] = [
  ...
  },
  {
    ...
    websiteUrl: "https://gamma.app", affiliateUrl: "https://gamma.app/?ref=aivault", imageUrl: "https://icon.horse/icon/gamma.app", tags: ["productivity", "presentations", "documents", "design"],
  ...
  },
  {
    ...
    websiteUrl: "https://chat.deepseek.com", affiliateUrl: "https://chat.deepseek.com/?ref=aivault", imageUrl: "https://icon.horse/icon/deepseek.com", tags: ["chat", "coding", "reasoning", "open-source", "math"],
    isFeatured: false, isTrending: true, alternatives: ["chatgpt", "claude"],
  ...
  },
  {
    ...
    websiteUrl: "https://sora.com", affiliateUrl: "https://sora.com/?ref=aivault", imageUrl: "https://icon.horse/icon/openai.com",
