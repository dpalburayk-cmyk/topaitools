...
export const metadata: Metadata = {
  ...
  description: "Discover, compare, and choose the best AI tools. 40+ curated tools across 9 categories with honest reviews and ratings.",
  openGraph: {
    title: "Top AI Tools — The Ultimate AI Tools Directory",
    description: "40+ AI tools across 9 categories with honest reviews.",
  },
};
      ...
      <div className="relative z-10">
        ...
        <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pt-32 pb-20 text-center">
          ...
          <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-10 leading-relaxed">
            ...
            Honest reviews, real ratings, and up-to-date insights — all in one place.
          </p>
